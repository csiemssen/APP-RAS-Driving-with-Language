...
from src.utils.utils import is_mps, flatten
...
class GemmaInferenceEngine(BaseInferenceEngine):
    def __init__(self, model_path: str = "google/gemma-3-4b-it", revision: Optional[str] = None, device: Optional[str] = None, use_4bit: bool = True):
